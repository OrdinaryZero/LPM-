...
<body class="bg-gray-100 h-screen flex overflow-hidden">
    ...
    <aside class="w-64 bg-[#1f2328] text-white flex flex-col hidden md:flex h-full shadow-2xl relative z-20">
        ...
        <div class="flex-1 overflow-y-auto py-6 px-4 space-y-2">
            ...
            <a href="{{ route('admin.rescue.index') }}" class="flex items-center gap-3 px-4 py-3 text-white hover:text-white hover:bg-[#1f2328] rounded-xl transition-all duration-300 group mb-2">
            ...
            <div class="pt-4">
                ...
                <a href="{{ route('admin.struktur.index') }}" class="flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-white/10 rounded-xl font-semibold transition-colors">
