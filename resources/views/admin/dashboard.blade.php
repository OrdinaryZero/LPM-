...
<body class="bg-gray-100 h-screen flex overflow-hidden">
    ...
    <aside class="w-64 bg-[#1f2328] text-white flex flex-col hidden md:flex h-full shadow-2xl relative z-20">
        ...
        <div class="flex-1 overflow-y-auto py-6 px-4 space-y-2">
            ...
            <a href="#" class="flex items-center gap-3 px-4 py-3 bg-[#d4a017] text-white rounded-xl font-bold transition-colors shadow-[0_4px_15px_rgba(212,160,23,0.3)]">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
                Live Report
            </a>
            
            <a href="{{ route('admin.logs') }}" class="flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-white/10 rounded-xl font-semibold transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-extrabold text-gray-900">{{ $totalLaporanHariIni }}</h3>
                    </div>
                ...
                <div class="bg-gradient-to-br from-red-600 to-red-700 p-6 rounded-2xl shadow-lg flex items-center justify-between text-white">
                    <div>
                        ...
                        <h3 class="text-3xl font-extrabold">{{ $totalAmbulance }}</h3>
                    </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-extrabold text-gray-900">{{ $totalRescue }}</h3>
                    </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between group">
                    <div>
                        ...
                        <h3 class="text-3xl font-extrabold text-green-600">{{ count($petugas_aktif) }} <span class="text-sm font-medium text-gray-400">Orang</span></h3>
                    </div>
                            ...
                            <tbody class="text-sm divide-y divide-gray-50">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="p-4">
                                        ...
                                        @else
                                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-bold bg-gray-100 text-gray-500 border border-gray-200">
                                                Off Duty
                                            </span>
                                        @endif
                                    </td>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 flex flex-col h-[500px]">
                    ...
                    <div class="p-4 flex-1 flex flex-col gap-4 bg-gray-50 overflow-y-auto">
                        ...
                        <div class="relative bg-black rounded-xl overflow-hidden shadow-inner h-40 group cursor-pointer">
                            ...
                            <div class="absolute bottom-3 left-3 text-white/80 text-xs font-bold z-10 drop-shadow-md">
                                CAM 01 - Gerbang Utama
                            </div>
                            <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent z-0"></div>
                            <div class="absolute inset-0 opacity-10 bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0IiBoZWlnaHQ9IjQiPgo8cmVjdCB3aWR0aD0iNCIgaGVpZ2h0PSI0IiBmaWxsPSIjZmZmIi8+CjxwYXRoIGQ9Ik0wIDBoNHYxSDB6TTAgMmg0djFIMHoiIGZpbGw9IiMwMDAiLz4KPC9zdmc+')] mix-blend-overlay pointer-events-none"></div>
