...
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="max-w-7xl mx-auto p-8">
        <div class="mb-8">
            ...
            <p class="text-gray-500 font-medium text-sm mt-1">Atur jabatan, letak baris tampilan, dan urutan scroll dari kiri ke kanan.</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-fit">
                ...
                <form action="{{ route('admin.struktur.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1">Urutan Dalam Baris</label>
                        <input type="number" name="urutan" value="1" required class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:ring-2 focus:ring-[#d4a017] outline-none text-sm" title="Makin kecil angka, makin di depan">
                    </div>
                    <div>
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100">
                    <h3 class="font-bold text-lg text-gray-800">Daftar Pengurus Terdaftar</h3>
                </div>
                    ...
                    <table class="w-full text-left">
                        <thead class="bg-gray-50/50 text-xs text-gray-400 uppercase tracking-wider">
                            <tr>
                                ...
                                <th class="p-4 font-bold border-b border-gray-100 text-center">Posisi Baris</th>
                        ...
                        <tbody class="divide-y divide-gray-50 text-sm">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="p-4 text-center">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-bold bg-[#d4a017]/10 text-[#d4a017]">
                                        Baris {{ $item->baris }}
                                    </span>
                                </td>
